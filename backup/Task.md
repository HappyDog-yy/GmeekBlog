...
![Image](https://github.com/user-attachments/assets/5ec7eae5-5fca-4680-aa63-85e450371f7e)
...
![Image](https://github.com/user-attachments/assets/6692b6c5-9832-4b26-b822-fc4c0bda0a73)
...
- 在遍历**连续内存**时，下一个元素大概率已在缓存中，称为**缓存命中**，速度极快，对应的数据结构有```vector``` ；
- 而在遍历**分散内存**时，访问下一节点需要重新去主内存读取，称为**缓存缺失**，速度较慢，对应的数据结构有```链表``` 。
...
![Image](https://github.com/user-attachments/assets/32a5fe76-2525-4d58-b3f6-6df11632fea0)